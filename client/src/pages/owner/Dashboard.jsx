      ...
      <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
        ...
        <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
                ...
                <div key={index} className='mt-4 flex items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    <div className='hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-primary/10'>
                      <img src={assets.carIconColored} alt='car' className='h-5 w-5'/>
                    </div>
                    <div>
          ...
          <div className='p-4 md:p-6 border border-borderColor rounded-md w-full md:max-w-xs'>
            ...
            <p className='text-gray-500'>Monthly for current month</p>
            <p className='text-3xl font-semibold mt-6 text-primary'>{currency}{data.monthlyRevenue}</p>
          </div>
