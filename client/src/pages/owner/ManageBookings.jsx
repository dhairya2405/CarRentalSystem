        ...
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          <thead className='text-gray-500'>
            <tr>
               ...
               <th className='p-3 font-medium max-md:hidden'>Date Rangey</th>
              ...
              <tr key={index} className='border-t border-borderColor text-gray-500'>
                ...
                <td className='p-3'>
                  {booking.status==='pending'?(
                    <select className='px-2 py-1.5 mt-1 text-gray-500 border border-borderColor rounded-md outtline-none' value={booking.status} onChange={e=>changeBookingStatus(booking._id,e.target.value)}>
